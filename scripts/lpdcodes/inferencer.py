...
from nvidia_tao_deploy.cv.BDLPRnet.scripts.inferencer.trt_inferencer import TRTInferencer
from nvidia_tao_deploy.cv.BDLPRnet.scripts.inferencer.utils import allocate_buffers, do_inference
def trt_output_process_fn(y_encoded):
    """Function to process TRT model output."""
    keep_k, boxes, scores, cls_id = y_encoded
    #keep_k, boxes = y_encoded
    #print(" Y_encoded1", keep_k)
    #print(" Y_encoded2", boxes)
